...
const SessionInProgress = ({
  ...
  return (
    <>
      {/* Video element - Always mounted but hidden during splash to keep webcam active */}
      <video
        ref={videoRef}
        style={{
          position: 'fixed',
          ...
          borderRadius: '4px',
          objectFit: 'cover',
          opacity: showSplash ? 0 : 0.5, // Hide during splash but keep in DOM
          pointerEvents: 'none',
          zIndex: showSplash ? -1 : 1 // Send behind splash
        }}
        width="640"
        height="480"
        autoPlay
